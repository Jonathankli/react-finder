...
var useFolder = function (tree, setTree, contentRef, dropOnFile, folderFactory) {
    ...
    var _a = useState([]), activeItems = _a[0], setActiveItems = _a[1];
    var _b = useState(SELECT_TYPE.CHILDREN), detailView = _b[0], setDetailView = _b[1];
    var hasChildren = useCallback(function (id) {
    ...
    var detailItem = useMemo(function () {
